...
# If using mechanisms, need have "current" in the master equation
master_eqns = '''
...
# Notes:
# - If you don't want to use mechanism files for your neurons, you can just pass your equations as "master_eqns"

# The parentheses are important! (this is Python, not Matlab!)
...
# Notes:
# - If you don't want to use mechanism files for your synapses, you MUST keep track of which equations go in the "master_eqns"
